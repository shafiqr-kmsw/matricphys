...
const documents = [
  { name: "1) Surat Pelantikan Pertama Skim Perkhidmatan Pendidikan di Gred DG41/DG9", link: "" },
  ...
  { name: "6) Surat Pemakluman Pengisytiharan Harta", link: "" },
  { name: "7) Jadual Waktu Mengajar (bagi tahun 2022, 2023, 2024 dan 2025", link: "" },
  ...
  { name: "26) Bengkel Pembinaan Buku Tutorial", link: "" },
  { name: "27) Bengkel Pembinaan Buku Tutorial", link: "" },
  { name: "28) Bengkel Latihan Adobe InDesign", link: "files/28.pdf" },
  { name: "29) PROGRAM BOOK SHARING", link: "" },
  { name: "30) BENGKEL SMARTPHYSICS", link: "files/24.pdf" },
  { name: "31) Bengkel Profesionalisme Pensyarah", link: "" },
  { name: "32) PROGRAM CELIK DIGITAL", link: "" },
  { name: "33) Bengkel Penulisan Kajian Tindakan", link: "" },
  { name: "34) Bengkel Perancangan Ilmu Sains", link: "" },
  { name: "35) Taklimat Pengawasan Peperiksaan", link: "files/35.pdf" },
  { name: "36) PROGRAM AKADEMI YOUTUBE", link: "" },
  { name: "37) FLIPPED CLASSROOMS", link: "" },
  { name: "38) Wacana Ilmu Pemurnian Soalan", link: "" },
  { name: "39) Bengkel Modul STEM", link: "" },
  { name: "40) Bengkel Looker Studio", link: "" },
  { name: "41) KOLOKIUM PENDIDIKAN", link: "files/15.pdf" },
  { name: "42) Bengkel Pemurnian Bahan Amali", link: "" },
  ...
  { name: "47) PSPM2 Physics Results Report", link: "" },
  { name: "48) PSPM1 Physics Results Report", link: "" },
